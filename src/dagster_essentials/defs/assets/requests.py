...
def adhoc_request(context: dg.AssetExecutionContext, config: AdhocRequestConfig, database: DuckDBResource) -> None:
    """
    ...
    if results_pivot.select_dtypes(include="number").empty:
